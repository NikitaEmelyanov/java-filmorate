...
public class UserRepository extends BaseRepository<User> {
    ...
    private static final String FIND_ALL_FRIENDS_USER_BY_ID_QUERY =
    ...
    private static final String DELETE_FRIEND_BY_USER_ONE_ID_QUERY =
        "DELETE FROM friendship WHERE user_one_id = ? AND " +
        "user_two_id = ?";
